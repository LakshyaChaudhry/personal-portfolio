...
tags: ["ai", "fine-tuning", "productivity"]
published: true
---
...
*I'd pause working on Signal for the moment as the functionality serves me well for the time being. If you're interested in local AI personalization, I'd love to hear what you're working on—reach out on [Twitter/X](https://x.com/lakshyachaudhry) or [email](mailto:lakshyachaudhry@gmail.com).*
